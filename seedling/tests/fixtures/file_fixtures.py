...
def sample_files(temp_directory: Path) -> Generator[Dict[str, Path], None, None]:
    ...
    files["data"].write_text("id,name,email\n1,Alice,alice@example.com\n2,Bob,bob@example.com")
...
@pytest.fixture
def mock_file_system() -> Generator[Dict[str, Path], None, None]:
...
def nested_directory_structure(temp_directory: Path) -> Generator[Path, None, None]:
    ...
    (temp_directory / "level1" / "level2" / "level3" / "level3.txt").write_text("level3 file")
